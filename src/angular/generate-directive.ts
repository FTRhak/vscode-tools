...
export function angularCommandGenerateDirective(context: vscode.ExtensionContext): vscode.Disposable[] {
                    ...
                    message => {
                        if (message.command === 'angular-create-directive') {
                            ...
                            if (message.type === 'ng') {
                                ...
                                command = `nx g @nx/angular:directive ${path}/${in_folder?(name + '/'):''}${name}${sufix?'.directive':''}`
