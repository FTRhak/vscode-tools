...
explorer/context
  └── schematicsSubmenu ("Schematics Tools")
        ├── schematicsAngularSubmenu — application, class, component, config, directive, environment, guard, interceptor, library, pipe, module, resolver, service, service-worker
